/**
 * BLOCK: Latest post list block - Gutenberg (WPGL)
 *
...
registerBlockType( 'wpgl-gutenberg-block/latestposts', {
	title: __( 'Wpgl latest posts', 'wpgl-blocks' ), // Block title.
	...
	keywords: [
		__( 'Wpgl latest posts — WPGL Block' ),
	...
	edit: function( props ) {
		...
		return (
			<Fragment>
        <GridPlaceholder
          placeholderLabel = {__("Latest posts")}
